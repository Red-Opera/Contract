...
{  
   ...
   {
	   GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::Red, TEXT("GunFire socket이 존재하지 않음."));
       return;
   }
...
void AGun_AK47::Fire()
{
    ...
    // 남은 총알 수 출력
	GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::Green, FString::Printf(TEXT("최대 총알 수: %d"), ammoCount));
